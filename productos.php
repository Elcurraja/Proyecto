  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" onclick ="insert_producto()" id="add">Añadir Nuevo Producto</button>
        <button type="button" class="btn btn-primary" onclick ="edit_producto()" id="edit" style="display:none">Editar Producto</button>
      </div>
    </div>
  </div>
</div>
